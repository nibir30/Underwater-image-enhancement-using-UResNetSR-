...
def main():
    ...
    sumuiqm, sumuciqe, sumuicm, sumuism, sumuiconm = 0.,0.,0.,0.,0.
    ...
    for imgdir in result_dirs:
        if '.png' in imgdir:
            ...
            uiqm,uciqe,uicm,uism,uiconm = nmetrics(corrected)
            ...
            with open(os.path.join(result_path,'metrics.txt'), 'a') as f:
                f.write('{}: uiqm={} uciqe={} uicm={} uism={} uiconm={}\n'.format(imgdir,uiqm,uciqe,uicm,uism,uiconm))
    ...
    with open(os.path.join(result_path,'metrics.txt'), 'a') as f:
        f.write('Average: uiqm={} uciqe={} uuicm={} uuism={} uuiconm={}\n'.format(muiqm, muciqe,uuicm,uuism,uuiconm))
